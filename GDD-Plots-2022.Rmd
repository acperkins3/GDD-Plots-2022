...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("06/10/2022", "%m/%d/%y"), y = 1350, label = "~ start of flowering") +
  ...
  geom_hline(yintercept = 2145, linetype = 'dotted', col = 'black') +
  annotate("text", x = as.Date("06/10/2022", "%m/%d/%y"), y = 1990, label = "~ GEMN drooping ears")
...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("06/15/2022", "%m/%d/%y"), y = 2050, label = "~ 35% dry matter silage") +
