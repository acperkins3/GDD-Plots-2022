...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("05/25/2022", "%m/%d/%y"), y = 1250, label = "Approximate start of flowering") +
  geom_hline(yintercept = 120, linetype = 'dotted', col = 'blue') +
  annotate("text", x = as.Date("05/25/2022", "%m/%d/%y"), y = 170, label = "Approximate time of emergence") +
