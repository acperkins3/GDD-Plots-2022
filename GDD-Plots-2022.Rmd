...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("06/10/2022", "%m/%d/%y"), y = 1350, label = "Approximate start of flowering") +
  ...
  annotate("text", x = as.Date("06/10/2022", "%m/%d/%y"), y = 2550, label = "~Black layer / physiological maturity")
...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("06/02/2021", "%m/%d/%y"), y = 2050, label = "~ 35% dry matter silage") +
...
ggplot(WMARSExisting, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  geom_hline(yintercept = 1200, linetype = 'dotted', col = 'blue') +
  annotate("text", x = as.Date("06/10/2022", "%m/%d/%y"), y = 1100, label = "Approximate start of flowering") +
  geom_hline(yintercept = 120, linetype = 'dotted', col = 'blue') +
  geom_hline(yintercept = 2700, linetype = 'dotted', col = 'black') +
  annotate("text", x = as.Date("06/10/2022", "%m/%d/%y"), y = 2550, label = "~Black layer / physiological maturity")
...
ggplot(M800Flowering, aes(GDDs, ProportionFlowered, color = Field)) +
  geom_line() +
